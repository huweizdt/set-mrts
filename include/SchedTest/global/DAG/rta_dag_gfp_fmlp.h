...
#ifndef INCLUDE_SCHEDTEST_GLOBAL_DAG_RTA_DAG_GFP_FMLP_H_
#define INCLUDE_SCHEDTEST_GLOBAL_DAG_RTA_DAG_GFP_FMLP_H_
...
class RTA_DAG_GFP_FMLP : public GlobalSched {
 protected:
  DAG_TaskSet tasks;
 ...
 public:
  RTA_DAG_GFP_FMLP();
  RTA_DAG_GFP_FMLP(DAG_TaskSet tasks, ProcessorSet processors,
                   ResourceSet resources);
  ~RTA_DAG_GFP_FMLP();
  bool is_schedulable();
};

#endif  // INCLUDE_SCHEDTEST_GLOBAL_DAG_RTA_DAG_GFP_FMLP_H_
