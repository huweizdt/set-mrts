...
#ifndef INCLUDE_SCHEDTEST_GLOBAL_DAG_RTA_DAG_GEDF_MEL_H_
#define INCLUDE_SCHEDTEST_GLOBAL_DAG_RTA_DAG_GEDF_MEL_H_
...
class RTA_DAG_GEDF_MEL : public GlobalSched {
 protected:
  DAG_TaskSet tasks;
 ...
 public:
  RTA_DAG_GEDF_MEL();
  RTA_DAG_GEDF_MEL(DAG_TaskSet tasks, ProcessorSet processors,
                   ResourceSet resources);
  ~RTA_DAG_GEDF_MEL();
  bool is_schedulable();
};

#endif  // INCLUDE_SCHEDTEST_GLOBAL_DAG_RTA_DAG_GEDF_MEL_H_
