...
#ifndef INCLUDE_SCHEDTEST_GLOBAL_DAG_RTA_DAG_CGFP_PIP_H_
#define INCLUDE_SCHEDTEST_GLOBAL_DAG_RTA_DAG_CGFP_PIP_H_
...
class RTA_DAG_CGFP_PIP : public GlobalSched {
 protected:
  DAG_TaskSet tasks;
  ProcessorSet processors;
  ResourceSet resources;

  uint64_t resource_holding(const DAG_Task& ti, const DAG_Task& tx,
 ...
 public:
  RTA_DAG_CGFP_PIP();
  RTA_DAG_CGFP_PIP(DAG_TaskSet tasks, ProcessorSet processors,
                   ResourceSet resources);
  ~RTA_DAG_CGFP_PIP();
  bool is_schedulable();
};

#endif  // INCLUDE_SCHEDTEST_GLOBAL_DAG_RTA_DAG_CGFP_PIP_H_
