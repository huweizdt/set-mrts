...
#ifndef INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_NP_SM_OPA_H_
#define INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_NP_SM_OPA_H_
...
class RTA_PFP_RO_NP_SM_OPA : public PartitionedSched {
 protected:
  TaskSet tasks;
  ...
  ulong response_time_UA(const Task& ti);
 ...
 public:
  RTA_PFP_RO_NP_SM_OPA();
  RTA_PFP_RO_NP_SM_OPA(TaskSet tasks, ProcessorSet processors,
                       ResourceSet resources);
  ~RTA_PFP_RO_NP_SM_OPA();
  bool is_schedulable();
};

#endif  // INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_NP_SM_OPA_H_
