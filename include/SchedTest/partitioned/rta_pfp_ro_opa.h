...
#ifndef INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_OPA_H_
#define INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_OPA_H_
...
class RTA_PFP_RO_OPA : public PartitionedSched {
 protected:
  TaskSet tasks;
 ...
 public:
  RTA_PFP_RO_OPA();
  RTA_PFP_RO_OPA(TaskSet tasks, ProcessorSet processors, ResourceSet resources);
  ~RTA_PFP_RO_OPA();
  bool is_schedulable();
};

#endif  // INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_OPA_H_
