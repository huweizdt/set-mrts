...
#ifndef INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_NP_OPA_P3_H_
#define INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_NP_OPA_P3_H_
...
class RTA_PFP_RO_NP_OPA_P3 : public PartitionedSched {
 protected:
  TaskSet tasks;
 ...
 public:
  RTA_PFP_RO_NP_OPA_P3();
  RTA_PFP_RO_NP_OPA_P3(TaskSet tasks, ProcessorSet processors,
                       ResourceSet resources);
  ~RTA_PFP_RO_NP_OPA_P3();
  bool is_schedulable();
};

#endif  // INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_NP_OPA_P3_H_
