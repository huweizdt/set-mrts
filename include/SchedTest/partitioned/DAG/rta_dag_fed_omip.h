...
#ifndef INCLUDE_SCHEDTEST_PARTITIONED_DAG_RTA_DAG_FED_OMIP_H_
#define INCLUDE_SCHEDTEST_PARTITIONED_DAG_RTA_DAG_FED_OMIP_H_
...
class RTA_DAG_FED_OMIP : public PartitionedSched {
 protected:
  DAG_TaskSet tasks;
 ...
 public:
  RTA_DAG_FED_OMIP();
  RTA_DAG_FED_OMIP(DAG_TaskSet tasks, ProcessorSet processors,
                      ResourceSet resources);
  ~RTA_DAG_FED_OMIP();
...
#endif  // INCLUDE_SCHEDTEST_PARTITIONED_DAG_RTA_DAG_FED_OMIP_H_
