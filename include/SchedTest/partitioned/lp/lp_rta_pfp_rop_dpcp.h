...
#ifndef INCLUDE_SCHEDTEST_PARTITIONED_LP_LP_RTA_PFP_ROP_DPCP_H_
#define INCLUDE_SCHEDTEST_PARTITIONED_LP_LP_RTA_PFP_ROP_DPCP_H_
...
class LP_RTA_PFP_ROP_DPCP : public PartitionedSched {
 protected:
  TaskSet tasks;
 ...
 public:
  LP_RTA_PFP_ROP_DPCP();
  LP_RTA_PFP_ROP_DPCP(TaskSet tasks, ProcessorSet processors,
                      ResourceSet resources);
  ~LP_RTA_PFP_ROP_DPCP();
  bool is_schedulable();
};

#endif  // INCLUDE_SCHEDTEST_PARTITIONED_LP_LP_RTA_PFP_ROP_DPCP_H_
