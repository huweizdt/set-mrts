...
|                |                     |                      |                      |                      |
|(63-39)Reserved |(38-36) var type     |(35-26) Task          |(25-16) Resource      |(15-0) Request        |
|________________|_____________________|______________________|______________________|______________________|
*/
...
class ILP_RTA_FED_H2LP : public PartitionedSched {
 protected:
  ...
  void lp_h2lp_constraint_7(const DAG_Task& ti, LinearProgram* lp,
                            H2LPMapper* vars);

  void lp_h2lp_constraint_8(const DAG_Task& ti, LinearProgram* lp,
                            H2LPMapper* vars);

  void lp_h2lp_constraint_9(const DAG_Task& ti, LinearProgram* lp,
                            H2LPMapper* vars);

  void lp_h2lp_constraint_10(const DAG_Task& ti, LinearProgram* lp,
                            H2LPMapper* vars);
