...
#ifndef INCLUDE_SCHEDTEST_PARTITIONED_DAG_ILP_RTA_FED_H2LP_V4_H_
#define INCLUDE_SCHEDTEST_PARTITIONED_DAG_ILP_RTA_FED_H2LP_V4_H_
...
class H2LPMapper_v4 : public VarMapperBase {
 public:
  enum var_type {
    REQUEST_NUM,   
    BLOCKING_SPIN,         
 ...
 public:
  explicit H2LPMapper_v4(uint start_var = 0);
...
class ILP_RTA_FED_H2LP_v4 : public PartitionedSched {
 protected:
  DAG_TaskSet tasks;
  ...
  void objective(const DAG_Task& ti, H2LPMapper_v4* vars, LinearExpression* obj);
  ...
  void spining_blocking(const DAG_Task& ti,
                        H2LPMapper_v4* vars, LinearExpression* exp,
                        double coef = 1);
 ...
 public:
  ILP_RTA_FED_H2LP_v4();
  ILP_RTA_FED_H2LP_v4(DAG_TaskSet tasks, ProcessorSet processors,
                      ResourceSet resources);
  ~ILP_RTA_FED_H2LP_v4();
  bool is_schedulable();
};
...
/*
class ILP_RTA_FED_H2LP_v4_FF : public ILP_RTA_FED_H2LP_v4 {
 public:
  ILP_RTA_FED_H2LP_v4_FF();
  ILP_RTA_FED_H2LP_v4_FF(DAG_TaskSet tasks, ProcessorSet processors,
                      ResourceSet resources);
  ~ILP_RTA_FED_H2LP_v4_FF();
  bool is_schedulable();
};
...
class ILP_RTA_FED_H2LP_v4_UTIL : public ILP_RTA_FED_H2LP_v4 {
 public:
  ILP_RTA_FED_H2LP_v4_UTIL();
  ILP_RTA_FED_H2LP_v4_UTIL(DAG_TaskSet tasks, ProcessorSet processors,
                      ResourceSet resources);
  ~ILP_RTA_FED_H2LP_v4_UTIL();
  bool is_schedulable();
};

class ILP_RTA_FED_H2LP_v4_HEAVY : public ILP_RTA_FED_H2LP_v4 {
 public:
  ILP_RTA_FED_H2LP_v4_HEAVY();
  ILP_RTA_FED_H2LP_v4_HEAVY(DAG_TaskSet tasks, ProcessorSet processors,
                      ResourceSet resources);
  ~ILP_RTA_FED_H2LP_v4_HEAVY();
  bool is_schedulable();
};

#endif  // INCLUDE_SCHEDTEST_PARTITIONED_DAG_ILP_RTA_FED_H2LP_v4_H_
