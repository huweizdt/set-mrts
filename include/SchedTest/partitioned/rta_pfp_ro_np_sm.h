...
#ifndef INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_NP_SM_H_
#define INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_NP_SM_H_
...
class RTA_PFP_RO_NP_SM : public PartitionedSched {
 protected:
  TaskSet tasks;
 ...
 public:
  RTA_PFP_RO_NP_SM();
  RTA_PFP_RO_NP_SM(TaskSet tasks, ProcessorSet processors,
                   ResourceSet resources);
  ~RTA_PFP_RO_NP_SM();
  bool is_schedulable();
};

#endif  // INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_NP_SM_H_
