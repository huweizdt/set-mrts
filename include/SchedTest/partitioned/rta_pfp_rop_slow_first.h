...
#ifndef INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_ROP_SLOW_FIRST_H_
#define INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_ROP_SLOW_FIRST_H_
...
static uint ROP_SF_P = 0;

class RTA_PFP_ROP_SLOW_FIRST : public PartitionedSched {
 protected:
  TaskSet tasks;
 ...
 public:
  RTA_PFP_ROP_SLOW_FIRST();
  RTA_PFP_ROP_SLOW_FIRST(TaskSet tasks, ProcessorSet processors,
                         ResourceSet resources);
  ~RTA_PFP_ROP_SLOW_FIRST();
...
#endif  // INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_ROP_SLOW_FIRST_H_
