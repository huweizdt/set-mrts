...
#ifndef INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_NP_OPA_P2_H_
#define INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_NP_OPA_P2_H_
...
class RTA_PFP_RO_NP_OPA_P2 : public PartitionedSched {
 protected:
  TaskSet tasks;
 ...
 public:
  RTA_PFP_RO_NP_OPA_P2();
  RTA_PFP_RO_NP_OPA_P2(TaskSet tasks, ProcessorSet processors,
                       ResourceSet resources);
  ~RTA_PFP_RO_NP_OPA_P2();
  bool is_schedulable();
};

#endif  // INCLUDE_SCHEDTEST_PARTITIONED_RTA_PFP_RO_NP_OPA_P2_H_
